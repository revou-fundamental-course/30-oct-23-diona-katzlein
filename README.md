...
```bash
$ git clone https://github.com/revou-fundamental-course/30-oct-23-diona-katzlein.git
```
2. Setelah proses cloning selesai, masuk ke dalam direktori proyek
```bash
$ cd 30-oct-23-diona-katzlein
```
3. Buka file index.html dengan peramban web untuk menggunakan kalkulator BMI.

Create with ♥ by <a href="https://github.com/diona-katzlein/">Diona Katzlein</a>